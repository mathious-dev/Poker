...
public class Gestion
{
    ...
    public void Test()
    {
        ...
        var player1=new Player
        {
            ...
            Deck=new Card[]
            {
                new Card { Number = 13, Type = TypeCard.Coeur },
                new Card { Number = 14, Type = TypeCard.Coeur }
            }
